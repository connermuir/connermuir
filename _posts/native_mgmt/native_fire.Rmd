...
```{r}
knitr::include_graphics('native_fire_files/fire.webp')
```

[Source: Sippakorn Yamkasikorn](https://www.brencomm.com/post/the-case-for-native-led-forest-management-in-california)
